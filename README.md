...
This repository contains the code and resources associated with the paper "[Soft Measures for Extracting Causal Collective Intelligence](https://arxiv.org/pdf/2409.18911)". The content is organized into various directories, each serving a specific purpose related to the project's objectives.
